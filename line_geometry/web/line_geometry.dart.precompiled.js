...
"%":"CanvasGradient|CanvasPattern|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|TextMetrics"},
kn:{
"":"bool/Gv;",
...
for(z=C.u5.gA(b);z.G();)this.h(a,z.mD)},
...
else if(typeof y!=="object"||y===null||!x.$ishJ)z.ret=y.HA()
y=this.Iq
...
"":"a;"},
KA:{
"":"a;dB,o7,ls,Lj<,Gv,lz,Ri",
WN:function(a){if(a==null)return
this.Ri=a
if(!a.gjz(a)){this.Gv=(this.Gv|64)>>>0
a.t2(this)}},
...
$isGe:true,
static:{SY:function(a){return new P.pu(a)}}},
lj:{
"":"Ge;G1",
...
$asMO:null}}],["dart.math","dart:math",,P,{
"":"",
...
z.push(b+w*p)}}}return new Float64Array(P.XF(z))},
yj:function(a,b,c,d,e,f){var z,y
z=(b-d)*(e-a)+(c-a)*(f-b)
if(z<-1e-9)y=17
else y=z>1e-9?18:16
return y}}],["lines","line_geometry.dart",,B,{
"":"",
Iq:[function(){var z=document.querySelector("#lineA")
new B.uj(z,null,null,null,null,null,null,null,null,null,null,null,null).za(z)
B.N0(document.querySelector("#lineB"))},"call$0","eE",0,0,0],
uj:{
"":"a;qN,eo,qe,w6,Kk,Rd,QH,ev,Lt,Gj,cN,R,fg",
pU:function(a,b,c,d,e,f){var z,y,x,w,v,u,t,s,r,q,p,o
z=b.BV
y=z.Zh
z=z.WB
x=b.eX
...
p[0]=C.CD.Hp(c+v*q)
p[1]=C.CD.Hp(d+u*q)}else p=null
o=p==null?new Float64Array(0):p
z=o.length
...
v=w.hp(w)
v*=v
if(v>0){u=new Q.XE(null,null)
u.Zh=0
u.WB=0
t=x.W(x,y).ZS(w)/v
u.Zh=C.CD.Hp(w.Zh*t+y.Zh)
u.WB=C.CD.Hp(w.WB*t+y.WB)}else u=null
this.Kk=u
s=C.CD.yu(C.CD.UD(u.Zh))
r=C.CD.yu(C.CD.UD(this.Kk.WB))
this.Gj="["+s+","+r+"]"
z=this.eo
J.yc(z,"rgb(255, 247, 239)")
z.fillRect(0,0,this.R,this.fg)
this.uX(32,"rgb(247, 231, 221)")
z=this.eo
J.RE(z).sEJ(z,"11pt Arial")
z.fillStyle="rgb(0,0,0)"
C.Tr.lR(z,"Infinite line",20,20)
C.Tr.lR(z,"Finite line",20,36)
if(this.Lt===!0){z=this.eo
J.RE(z).sku(z,"rgb(255,0,255)")
z.beginPath()
C.Tr.HT(z,10,16,6,0,6.283185307179586)
z.fill()
z.closePath()}if(this.ev===!0){z=this.eo
J.RE(z).sku(z,"rgb(0,0,255)")
z.beginPath()
C.Tr.HT(z,10,32,6,0,6.283185307179586)
z.fill()
z.closePath()}this.QH.Am(this.eo)
this.Rd.Am(this.eo)
...
z.closePath()
z=this.eo
y=this.w6==null?"rgba(255,0,255,0.1)":"rgba(0,0,255,0.1)"
J.RE(z).sku(z,y)
z.beginPath()
y=this.Kk
C.Tr.HT(z,y.Zh,y.WB,16,0,6.283185307179586)
z.fill()
...
z=z.eX
x=this.qe
x=B.yj(y.Zh,y.WB,z.Zh,z.WB,x.Zh,x.WB)
z=this.eo
y=this.Gj
if(x===17){x=this.Kk
J.mi(z,y,x.Zh+7,x.WB+8)}else{z=J.cq(z,y).width
if(typeof z!=="number")return z.g()
y=this.eo
x=this.Gj
q=this.Kk
J.mi(y,x,q.Zh-(z+6),q.WB-2)}}z=this.Kk
if(z!=null){y=this.qe
p=y.Zh-z.Zh
o=y.WB-z.WB
n=C.jn.bu(C.CD.yu(C.CD.UD(10*Math.sqrt(p*p+o*o)))/10)
z=this.eo
J.RE(z).sEJ(z,"8pt Arial")
z.fillStyle="rgb(255,0,0)"
z.beginPath()
y=this.qe
C.Tr.HT(z,y.Zh,y.WB,3,0,6.283185307179586)
z.fill()
z.closePath()
z=this.Rd
y=z.BV
...
z=this.eo
if(x===18){y=this.qe
J.mi(z,n,y.Zh+7,y.WB+8)}else{z=J.cq(z,n).width
if(typeof z!=="number")return z.g()
y=this.eo
x=this.qe
J.mi(y,n,x.Zh-(z+6),x.WB-2)}}},
...
this.Gj=""
this.cN=0
z=F.ds(86,197,193,81)
this.Rd=z
z.qk="rgb(20,128,20)"
z.Ld=2.5
x=H.VM([],[J.P])
this.pU(x,this.Rd,0,0,this.R,0)
z=this.Rd
y=this.R
this.pU(x,z,y,0,y,this.fg)
y=this.Rd
z=this.R
w=this.fg
this.pU(x,y,z,w,0,w)
this.pU(x,this.Rd,0,this.fg,0,0)
w=x.length
...
this.ef()}},
Jw:{
"":"a;aj,t6,qN,eo,i0,Of,a,r,w3,Td,l0,Bd,xp,qq,Sm,kj,fZ,UH,z1,qX,R,fg,Jh,eI,Jw",
...
z=this.xp
u=Math.sin(w)
v.eX.WB=C.CD.Hp(y+z*u)
w=4.71238898038469-this.Sm
u=this.z1
y=u.BV.Zh
v=Math.cos(w)
u.eX.Zh=C.CD.Hp(y+x*v)
v=this.z1
x=v.BV.WB
y=Math.sin(w)
v.eX.WB=C.CD.Hp(x+z*y)
y=this.qX
z=this.UH.eX
x=z.Zh
v=y.BV
...
this.e8(this.z1)
this.e8(this.qX)
if(this.l0.length>0){J.yc(this.eo,"rgb(255,0,0)")
for(t=0;t<this.l0.length;t+=2){z=this.eo
J.RE(z).Q4(z)
y=this.l0
x=y.length
...
C.Tr.HT(z,v,y[u],5,0,6.283185307179586)
z.fill()
z.closePath()}}},
...
w=y.WB
v=a.eX
J.bj(z,B.we(x,w,v.Zh,v.WB,this.i0,!0))
J.bj(this.l0,B.we(y.Zh,y.WB,v.Zh,v.WB,this.Of,!0))
J.bj(this.l0,B.we(y.Zh,y.WB,v.Zh,v.WB,this.a,!0))
J.bj(this.l0,B.we(y.Zh,y.WB,v.Zh,v.WB,this.r,!0))
J.bj(this.l0,B.we(y.Zh,y.WB,v.Zh,v.WB,this.w3,!0))
J.bj(this.l0,B.we(y.Zh,y.WB,v.Zh,v.WB,this.Td,!1))},
...
this.i0=[80,50,150,50,180,80,180,200,150,230,80,230,50,200,50,80,80,50]
this.Of=[210,150,210,220,220,230,260,230,274,216]
this.a=[310,220,310,160,320,150,360,150,370,160,370,220,360,230,320,230,310,220]
this.r=[400,165,420,150,450,150,450,160]
this.w3=[480,140,490,130,520,130,530,140,530,170,520,180,480,180]
this.Td=[150,200,180,230,274,150,274,230,370,220,380,230,400,150,400,230,480,70,480,230,490,180,530,230]
z=this.Bd
y=F.ds(32,244,32+z,240)
this.UH=y
y.qk="rgb(0,128,255)"
y.Ld=2.5
z=F.ds(544,244,544-z,244)
this.z1=z
z.qk="rgb(0,128,255)"
z.Ld=2.5
y=this.UH.eX
z=z.eX
z=F.ds(y.Zh,y.WB,z.Zh,z.WB)
this.qX=z
z.qk="rgb(0,128,255)"
z.Ld=2.5
this.l0=H.VM([],[J.P])
...
this.eI=z
this.Jh=z
this.aj=P.SZ(C.fp,new B.Qw(this))},
static:{N0:function(a){var z=new B.Jw(null,null,a,null,null,null,null,null,null,null,null,300,240,0.3141592653589793,0,8,8,null,null,null,null,null,null,null,null)
z.Kd(a)
return z}}},
Qw:{
"":"Tp:10;a",
call$1:function(a){return this.a.ef()}}},1],["shapes2d","../../quarks_libs/bin/shapes2d.dart",,F,{
"":"",
Zf:{
"":"a;"},
WP:{
...
z.Zh=J.Oq(c)
z.WB=J.Oq(d)},
static:{ds:function(a,b,c,d){var z,y
z=new Q.XE(null,null)
z.Zh=0
z.WB=0
...
y.T4(a,b,c,d)
return y}}}}],["vector2d","../../quarks_libs/bin/vector2d.dart",,Q,{
"":"",
XE:{
"":"a;Zh<,WB",
...
if($desc instanceof Array)$desc=$desc[1]
u8.prototype=$desc
function yU(Y8,dB,o7,ls,Lj,Gv,lz,Ri){this.Y8=Y8
this.dB=dB
this.o7=o7
this.ls=ls
this.Lj=Lj
...
if($desc instanceof Array)$desc=$desc[1]
nP.prototype=$desc
function KA(dB,o7,ls,Lj,Gv,lz,Ri){this.dB=dB
this.o7=o7
this.ls=ls
this.Lj=Lj
this.Gv=Gv
...
if($desc instanceof Array)$desc=$desc[1]
ub.prototype=$desc
function pu(G1){this.G1=G1}pu.builtin$cls="pu"
if(!"name" in pu)pu.name="pu"
$desc=$collectedClasses.pu
if($desc instanceof Array)$desc=$desc[1]
pu.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
Pr.prototype=$desc
function uj(qN,eo,qe,w6,Kk,Rd,QH,ev,Lt,Gj,cN,R,fg){this.qN=qN
this.eo=eo
this.qe=qe
this.w6=w6
this.Kk=Kk
...
this.cN=cN
this.R=R
this.fg=fg}uj.builtin$cls="uj"
if(!"name" in uj)uj.name="uj"
$desc=$collectedClasses.uj
if($desc instanceof Array)$desc=$desc[1]
uj.prototype=$desc
function Jw(aj,t6,qN,eo,i0,Of,a,r,w3,Td,l0,Bd,xp,qq,Sm,kj,fZ,UH,z1,qX,R,fg,Jh,eI,Jw){this.aj=aj
this.t6=t6
this.qN=qN
this.eo=eo
this.i0=i0

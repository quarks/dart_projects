...
void main() {
  ...
  FONT_COLOR = 'rgb(0,0,128)';
  PAGE_NO_FONT = "7pt Arial";
  ...
  Page p;
  // Make pages
  book.pages.add(new Page(book, "- Introduction -", "layouts/intro_1.txt"));

  s = new Circle_Line_Anim.size(10,50,310,200);
  p = new Page(book, "- ${pn++} - ", "layouts/circle2line_1.txt");
  p.addSketch(s);
  book.pages.add(p);

  s = new Circle_Tangents_Anim.size(10,50,310,200);
  p = new Page(book, "- ${pn++} - ", "layouts/tan2circ_1.txt");
  p.addSketch(s);
  book.pages.add(p);
  
  s = new Circle_Circle_Anim.size(10,80,310,170);
  p = new Page(book, "- ${pn++} - ", "layouts/circle2circle_1.txt");
  p.addSketch(s);
  book.pages.add(p);

  s = new Oblong_Oblong_Anim.size(10,80,310,210);
  p = new Page(book, "- ${pn++} - ", "layouts/oblong2oblong_1.txt");
  p.addSketch(s);
  book.pages.add(p);
  
  s = new Oblong_Line_Anim.size(10,160,310,220);
  p = new Page(book, "- ${pn++} - ", "layouts/oblong2line_1.txt");
  p.addSketch(s);
  book.pages.add(p);

  s = new Line_Line_Anim.size(10,50,310,160);
  p = new Page(book, "- ${pn++} - ", "layouts/line2line_1.txt");
  p.addSketch(s);
  book.pages.add(p);

  s = new Line_Point_Anim.size(10,50,310,310);
  p = new Page(book, "- ${pn++} - ", "layouts/line2point_1.txt");
  p.addSketch(s);
  book.pages.add(p);

  book.pages.add(new Page(book, "- ${pn++} - ", "layouts/line2point_2.txt"));

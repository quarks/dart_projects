...
["dart.async", "dart:async", , P, {
  ...
  Future_wait: function(futures, eagerError) {
    ...
    for (t3 = new H.ListIterator(futures, 1, 0, null); t3.moveNext$0();) {
      future = t3._current;
      pos = t1.remaining_2;
  ...
  Future_wait_closure: {
    "": "Closure:13;box_0,eagerError_2,pos_3",
...
["", "imageloadertest.dart", , O, {
  "": "",
  main: [function() {
    var t1, e;
    t1 = document.querySelector("#picture");
    $.canvas = t1;
    $.context = J.getContext$1$x(t1, "2d");
    e = document.createElement("img", null);
    J.set$src$x(e, "images/disneypic2.jpg");
    t1 = J.get$onLoad$x(e);
    P.Future_wait([t1.get$first(t1)], false).then$1(new O.main_closure(e));
  }, "call$0", "main$closure", 0, 0, 0],
  main_closure: {
    "": "Closure:10;a_0",
    call$1: function(_) {
      return J.drawImage$3$x($.context, this.a_0, 0, 0);
    }
  }
},
1],
...
//# sourceMappingURL=imageloadertest.dart.js.map
//@ sourceMappingURL=imageloadertest.dart.js.map

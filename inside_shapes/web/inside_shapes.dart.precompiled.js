...
for(z=a.length,y=z-1,x=!1,w=0;w<z;v=w+1,y=w,w=v){u=a[w]
if(y<0||y>=z)return H.e(a,y)
t=a[y]
s=u.WB
if(!(s<c&&t.WB>=c))r=t.WB<c&&s>=c
else r=!0
if(r){r=u.Zh
r=r+(c-s)/(t.WB-s)*(t.Zh-r)<b
s=r}else s=!1
if(s)x=!x}return x}}],["inside_shape_1","inside_shapes.dart",,V,{
"":"",
Iq:[function(){var z=document.querySelector("#insideA")
new V.wY(null,null,null,null,null,0,0,z,null,null,null).GT(z)},"call$0","eE",0,0,0],
wY:{
"":"a;CN,ju,C8,dR,ab,aK,v3,qN,eo,R,fg",
...
this.LM(32,"rgb(247, 231, 221)")
z=this.CN
z.G3="rgba(0,0,255,0.3)"
z.qk="rgba(0,0,255,0.6)"
y=this.ju
y.G3="rgba(255,255,100,0.3)"
y.qk="rgba(200,200,50,0.6)"
y=this.C8
y.G3="rgba(0,255,0,0.3)"
y.qk="rgba(0,200,0,0.6)"
y=this.dR
y.G3="rgba(255,100,100,0.3)"
y.qk="rgba(200,50,50,0.6)"
y=this.ab
y.G3="rgba(100,255,255,0.3)"
y.qk="rgba(10,200,200,0.6)"
this.nI(z)
this.nI(this.ju)
this.nI(this.C8)
this.nI(this.dR)
...
y.stroke()
y.restore()},
nI:function(a){if(a.Is(a,this.aK,this.v3)){a.G3="rgba(200,200,200,0.3)"
a.qk="rgba(0,0,0,0.6)"}},
...
z=new F.jW(50,0,0,"rgb(192,192,192)","rgb(128,128,128)",2)
z.x=75
z.y=180
this.CN=z
z=new F.jW(30,0,0,"rgb(192,192,192)","rgb(128,128,128)",2)
z.x=128
z.y=49
this.ju=z
z=new F.PL(50,80,0,0,"rgb(192,192,192)","rgb(128,128,128)",2)
z.x=192
z.y=48
this.C8=z
this.dR=F.Y6(176,176,[0,0,-32,-64,32,0,-32,64])
this.ab=F.Y6(60,70,[-10,0,-20,-20,32,-70,0,-20,10,0,-50,80])
this.ef()}}},1],["shapes2d","../../quarks_libs/bin/shapes2d.dart",,F,{
"":"",
Zf:{
"":"a;"},
jW:{
...
a.stroke()
a.restore()},
bu:function(a){return"Circle ["+this.x+", "+this.y+"] radius  "+this.jn}},
PL:{
"":"Zf;R,fg,x,y,G3,qk,Ld",
Is:function(a,b,c){var z,y,x,w
z=this.x
y=this.y
x=this.R
w=this.fg
return b>=z&&c>=y&&b<=z+x&&c<=y+w},
bu:function(a){return"Oblong ["+this.x+", "+this.y+"] to ["+(this.x+this.R)+","+(this.y+this.fg)+"]   Width: "+this.R+"   Height: "+this.fg}},
mk:{
"":"Zf;nC,x,y,G3,qk,Ld",
Is:function(a,b,c){return B.TO(this.nC,b-this.x,c-this.y)},
...
z=z[0]
a.moveTo(z.Zh,z.WB)
for(y=1;z=this.nC,y<z.length;++y){z=z[y]
a.lineTo(z.Zh,z.WB)}a.closePath()
a.fill()
a.stroke()
a.restore()},
bu:function(a){return"Polygon offset ["+this.x+", "+this.y+"]  Vertices \n "+H.d(this.nC)},
OS:function(a,b,c){var z,y,x,w,v
this.x=a
this.y=b
this.nC=H.VM([],[Q.XE])
for(z=0;y=c.length,z<y;z+=2){x=this.nC
w=c[z]
v=z+1
...
y.WB=v
x.push(y)}},
static:{Y6:function(a,b,c){var z=new F.mk(null,0,0,"rgb(192,192,192)","rgb(128,128,128)",2)
z.OS(a,b,c)
return z}}}}],["vector2d","../../quarks_libs/bin/vector2d.dart",,Q,{
"":"",
XE:{
"":"a;Zh<,WB",
...
if($desc instanceof Array)$desc=$desc[1]
Rd.prototype=$desc
function wY(CN,ju,C8,dR,ab,aK,v3,qN,eo,R,fg){this.CN=CN
this.ju=ju
this.C8=C8
this.dR=dR
this.ab=ab
...
if($desc instanceof Array)$desc=$desc[1]
Zf.prototype=$desc
function jW(jn,x,y,G3,qk,Ld){this.jn=jn
this.x=x
this.y=y
this.G3=G3
this.qk=qk
...
if($desc instanceof Array)$desc=$desc[1]
jW.prototype=$desc
function PL(R,fg,x,y,G3,qk,Ld){this.R=R
this.fg=fg
this.x=x
this.y=y
this.G3=G3
...
if($desc instanceof Array)$desc=$desc[1]
PL.prototype=$desc
function mk(nC,x,y,G3,qk,Ld){this.nC=nC
this.x=x
this.y=y
this.G3=G3
this.qk=qk
this.Ld=Ld}mk.builtin$cls="mk"

...
VX:{
"":"Tp:12;c",
call$1:function(a){return this.c(a)}}}],["circles","circle_geometry.dart",,D,{
"":"",
Iq:[function(){var z=document.querySelector("#circ2circ_a")
new D.pa(null,null,z,null,null,null).MT(z)
z=document.querySelector("#circ2circ_b")
new D.Pl(null,null,z,null,null,null,!1,null,null,null,null).rs(z)
z=document.querySelector("#circ2circ_c")
new D.FR(null,z,null,null,null,null,null,null,null).PM(z)},"call$0","eE",0,0,0],
FR:{
"":"a;CN,qN,eo,aK,v3,Bb,G6,R,fg",
...
if(J.U6(o).gor(o)){z=this.eo
J.bs(z,"rgb(255, 0, 255)")
z.lineWidth=1
z.beginPath()
for(z=o.length,n=0;y=this.eo,n<z;n+=2){J.ur(y,this.aK,this.v3)
x=o[n]
w=n+1
if(w>=z)return H.e(o,w)
y.lineTo(x,o[w])
y.stroke()}J.UE(y)}this.CN.Am(this.eo)
if(C.u5.gor(o)){z=this.eo
...
this.v3=y
if(y>=x){y=this.fg
if(typeof y!=="number")return y.W();--y}this.v3=y
...
this.R=z.width
this.fg=z.height
y=H.VM(new W.Cq(z,C.Cm.Ph,!1),[null])
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(this.gf0(this)),y.Sg),[H.Kp(y,0)]).Zz()
...
x.Zh=0
x.WB=0
w=new F.jW(40,x,"rgb(192,192,192)","rgb(128,128,128)",2)
x.Zh=z/1.8
x.WB=y/1.9
this.CN=w
...
if(C.u5.gor(u)){this.fU(u,0,"rgb(255,0,255)")
...
u=h==null?new Float64Array(0):h
if(J.pO(u)){J.yc(this.eo,"rgb(255, 0, 0)")
for(z=u.length,e=0;e<z;e+=2){y=this.eo
J.RE(y).Q4(y)
x=u[e]
w=e+1
if(w>=z)return H.e(u,w)
C.Tr.kA(y,x,u[w],3,0,6.283185307179586,!1)
y.fill()
y.closePath()}}}},
...
u=x+1
if(u>=y)return H.e(a,u)
C.Tr.kA(w,v,a[u],3.5,0,6.283185307179586,!0)
w.fill()
w.closePath()}},
...
this.ef()}},
Pl:{
"":"a;EC,CN,qN,eo,aK,v3,li,Bb,G6,R,fg",
fB:function(a,b){var z,y,x
z=this.eo
J.bs(z,b)
z.lineWidth=1.2
...
i=h+1
s[h]=y+q*j}}}else i=0
j=i<4?C.u5.aM(s,0,i):s
if(C.u5.gor(j)){z=this.eo
J.yc(z,"rgb(255, 0, 0)")
z.beginPath()
...
x=y.Zh
z=z.eX
if(x===z.Zh&&y.WB===z.WB){y.Zh=C.pr.j1(C.CD.yu(J.Wy(this.R)))
z=this.EC
y=C.pr.j1(C.CD.yu(J.Wy(this.R)))
z.eX.Zh=y
y=this.EC
z=C.pr.j1(C.CD.yu(J.Wy(this.fg)))
y.BV.WB=z
z=this.EC
y=C.pr.j1(C.CD.yu(J.Wy(this.fg)))
z.eX.WB=y}this.li=!1
this.ef()},"call$1","gGg",2,0,10],
K9:[function(a,b){this.li=!1
this.ef()},"call$1","gcb",2,0,10],
...
x=J.RE(y)
this.Bb=C.CD.yu(J.Wy(x.gBb(y)))
this.G6=C.CD.yu(J.Wy(x.gG6(y)))
this.R=x.gR(y)
this.fg=x.gfg(y)
x=H.VM(new W.Cq(z,C.Cm.Ph,!1),[null])
H.VM(new W.xC(0,x.uv,x.Ph,W.VF(this.gf0(this)),x.Sg),[H.Kp(x,0)]).Zz()
x=H.VM(new W.Cq(z,C.Wh.Ph,!1),[null])
H.VM(new W.xC(0,x.uv,x.Ph,W.VF(this.gVY(this)),x.Sg),[H.Kp(x,0)]).Zz()
x=H.VM(new W.Cq(z,C.hV.Ph,!1),[null])
H.VM(new W.xC(0,x.uv,x.Ph,W.VF(this.gGg(this)),x.Sg),[H.Kp(x,0)]).Zz()
x=H.VM(new W.Cq(z,C.WL.Ph,!1),[null])
H.VM(new W.xC(0,x.uv,x.Ph,W.VF(this.gcb(this)),x.Sg),[H.Kp(x,0)]).Zz()
J.WB(z.style,"crosshair")
z=this.R
if(typeof z!=="number")return z.V()
x=this.fg
...
w.Zh=0
w.WB=0
v=new F.jW(55,w,"rgb(192,192,192)","rgb(128,128,128)",2)
w.Zh=z/2
w.WB=x/2
this.CN=v
v.G3="rgba(0,0,255,0.3)"
v.qk="rgba(0,0,255,0.6)"
...
w.Zh=0
w.WB=0
w=new F.WP(v,w,"rgb(192,192,192)","rgb(128,128,128)",2)
w.T4(20,40,z-20,x-40)
this.EC=w
w.qk="rgb(128,128,0)"
this.ef()}}},1],["dart._collection.dev","dart:_collection-dev",,H,{
"":"",
...
s=j+1
if(j<0||j>=16)return H.e(z,j)
z[j]=e+y*p}}return s<8?C.u5.aM(z,0,s):z}}],["shapes2d","../../quarks_libs/bin/shapes2d.dart",,F,{
"":"",
Zf:{
"":"a;"},
WP:{
...
return"Circle ["+H.d(z.Zh)+", "+H.d(z.WB)+"] radius  "+this.jn}}}],["vector2d","../../quarks_libs/bin/vector2d.dart",,Q,{
"":"",
XE:{
"":"a;Zh<,WB",
...
x.WB=y
return x},
gtU:function(a){return(this.Zh&0x1FFFFFFF)-(this.WB&0x1FFFFFFF)},
...
if($desc instanceof Array)$desc=$desc[1]
VX.prototype=$desc
function FR(CN,qN,eo,aK,v3,Bb,G6,R,fg){this.CN=CN
this.qN=qN
this.eo=eo
this.aK=aK
this.v3=v3
...
this.G6=G6
this.R=R
this.fg=fg}FR.builtin$cls="FR"
if(!"name" in FR)FR.name="FR"
$desc=$collectedClasses.FR
if($desc instanceof Array)$desc=$desc[1]
FR.prototype=$desc
function pa(CN,ju,qN,eo,R,fg){this.CN=CN
this.ju=ju
this.qN=qN
this.eo=eo
this.R=R
this.fg=fg}pa.builtin$cls="pa"
if(!"name" in pa)pa.name="pa"
$desc=$collectedClasses.pa
if($desc instanceof Array)$desc=$desc[1]
pa.prototype=$desc
function Pl(EC,CN,qN,eo,aK,v3,li,Bb,G6,R,fg){this.EC=EC
this.CN=CN
this.qN=qN
this.eo=eo
this.aK=aK
...
return[qE,Gh,rK,fY,Mr,xO,ct,nB,i3,it,QP,IF,Ny,Kh,TK,Y5,Gc,QQ,y4,d7,Um,oJ,DG,HA,vH,dY,Em,NW,rV,K4,QF,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,cr,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,In,wP,eP,AL,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,KR,ew,fs,bX,A6,MC,iQ,j2,Ea,lp,kd,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,YC,r0,nK,yp,c1,Mq,Nf,Nc,Mx,Q7,yK,Dh,ZJ,mU,eZ,IT,JY,Pq,kx,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,YS,UM,ZD,vt,wD,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Jo,Qm,HY,cQ,n6,FK,Pu,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,fc,Bj,NO,II,fP,X1,HU,oo,OW,Tf,AP,yH,FA,Av,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,cu,dC,wN,VX,FR,pa,Pl,a7,i1,xy,MH,SU,Ca,b8,vs,da,xw,dm,rH,mi,jb,wB,Gv,qh,lz,Rl,Jb,M4,B5,PI,MO,Kd,UO,Bc,VT,Fj,q1,Zz,ly,MF,u8,yU,nP,KA,qB,ez,fI,LV,dp,B3,CR,Qk,v1,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,BV,id,Fk,RO,Cq,xC,mg,hL,IN,tn,ue,GG,Os,Rd,iY,P2,Pr,Zf,WP,jW,XE]}